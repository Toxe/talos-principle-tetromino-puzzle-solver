...
int main()
{
    ...
    // run("World Hub A", "    Star Gate A", {8, 5}, {Tetromino::T, Tetromino::T, Tetromino::T, Tetromino::T, Tetromino::L, Tetromino::J, Tetromino::Z, Tetromino::Z, Tetromino::S, Tetromino::S});
