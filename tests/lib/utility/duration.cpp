...
#include "../../src/lib/utility/duration.hpp"
...
TEST_CASE("utility/duration")
{
    SECTION("print durations")
    {
        ...
        CHECK_THAT(print_duration(1'000ns), Catch::Matchers::Equals("1000.000 ns"));
        CHECK_THAT(print_duration(1'250ns), Catch::Matchers::Equals("1250.000 ns"));
        CHECK_THAT(print_duration(1'735ns), Catch::Matchers::Equals("1735.000 ns"));
        ...
        CHECK_THAT(print_duration(1'000'000ns), Catch::Matchers::Equals("1000.000 μs"));
        CHECK_THAT(print_duration(1'250'000ns), Catch::Matchers::Equals("1250.000 μs"));
        CHECK_THAT(print_duration(1'735'000ns), Catch::Matchers::Equals("1735.000 μs"));
        ...
        CHECK_THAT(print_duration(1'000'000'000ns), Catch::Matchers::Equals("1000.000 ms"));
        CHECK_THAT(print_duration(1'250'000'000ns), Catch::Matchers::Equals("1250.000 ms"));
        CHECK_THAT(print_duration(1'735'000'000ns), Catch::Matchers::Equals("1735.000 ms"));
